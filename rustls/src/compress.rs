...
pub mod tests {
    ...
    fn test_cache_evicts_lru() {
        ...
        let cert1 =
            CertificatePayloadTls13::from_x509_certificates([&cert].into_iter(), Some(b"1"));
        let cert2 =
            CertificatePayloadTls13::from_x509_certificates([&cert].into_iter(), Some(b"2"));
        let cert3 =
            CertificatePayloadTls13::from_x509_certificates([&cert].into_iter(), Some(b"3"));
        let cert4 =
            CertificatePayloadTls13::from_x509_certificates([&cert].into_iter(), Some(b"4"));
